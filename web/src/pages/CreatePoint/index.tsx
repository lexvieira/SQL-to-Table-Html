...
const CreatePoint = () => {
    ...
    const [manualPosition] = useState<[number, number]>([19.3786057,99.5117335]);
    const [manualPosition1] = useState<[number, number]>([19.367291, 99.510149]);    
    ...
    useEffect(() => {
        ...
        // https://servicodados.ibge.gov.br/api/v1/localidades/municipios/3500105
        ...
        <div id="page-create-point">
            ...
            <form onSubmit={handleSubmit}> 
                ...
                <fieldset>
                    ...
                    <MapContainer center={initialPosition[0] === 0 ? manualPosition : initialPosition} zoom={15}>
                    <TileLayer attribution='&copy; <a href="http://osm.org/copyright">OpenStreetMap</a> contributors'
                    url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png" />
                    <Markers />
                    <Marker key="35" position={initialPosition} >
                        <Popup>
                            Initial Position
                        </Popup>
                    </Marker>
